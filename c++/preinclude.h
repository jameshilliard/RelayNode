...
public:
	...
	T operator=(T desired) { store(desired); return obj; }
	T operator=(T desired) volatile { store(desired); return obj; }
...
public:
	...
	T operator=(T desired) { locked_atomic<T>::store(desired); return locked_atomic<T>::obj; }
	T operator=(T desired) volatile { store(desired); return locked_atomic<T>::obj; }
